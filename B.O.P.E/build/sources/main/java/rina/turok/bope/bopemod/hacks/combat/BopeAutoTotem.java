...
public class BopeAutoTotem extends BopeModule {
	...
	BopeSetting slider_health = create("Health", "AutoTotemHealth", 36.0, 1.0, 36.0);
	...
	public void update() {
		// 18 * 2 = 36.
		if (mc.player != null && mc.world != null && mc.player.getHealth() <= (float) slider_health.get_value(1.0)) {
