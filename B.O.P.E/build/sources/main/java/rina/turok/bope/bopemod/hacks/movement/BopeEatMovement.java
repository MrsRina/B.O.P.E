...
*
*/
public class BopeEatMovement extends BopeModule {
	BopeSetting mode = create("Mode", "EatMovementMode", "Packet", combobox("Packet"));
	...
	public BopeEatMovement() {
		super(BopeCategory.BOPE_MOVEMENT);

		// Info.
		this.name        = "Eat Movement";
		this.tag         = "EatMovement";
